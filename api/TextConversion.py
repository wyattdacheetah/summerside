...
<html lang="en-US">
  <head>
    ...
    <meta name="description" content="{Text} [To {To}] {Out}" />
    ...
    <meta property="og:description" content="{Text} [To {To}] {Out}" />
    ...
    <meta property="twitter:description" content="{Text} [To {To}] {Out}" />
  </head>
